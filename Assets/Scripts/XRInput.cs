...
//This script handles all XR input interactions and sets up all the buttons for the controllers
//This script was pulled from wpetillo @ https://answers.unity.com/questions/1745237/how-to-get-vr-button-press-input-on-only-the-first.html
...
#pragma warning restore 0649
    ...
    private void Update()
    {
        ...
        foreach (var binding in bindings)
            binding.Update(rightHand.inputDevice);
        foreach (var binding in bindings)
            binding.Update(leftHand.inputDevice);
    }
}
...
//List of potential interactions with buttons
...
{
    //Switch case that sets up all XR button interactions that were defined above.
